...
- Fetch endpoints/queues: `transire info --env dev --profile transire-sandbox`.
- Exercise HTTP: `curl "https://<api-endpoint>/?msg=hello-aws"`.
- Exercise queues: `transire send work-events '{"source":"cli","detail":"aws send"}' --profile transire-sandbox --env dev`.
- Trigger schedule on-demand: `transire trigger heartbeat --profile transire-sandbox --env dev`.
